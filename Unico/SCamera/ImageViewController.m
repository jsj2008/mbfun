...
- (void)viewDidLoad {
    ...
    NSString *info = [NSString stringWithFormat:@"Size: %@  -  Orientation: %ld", NSStringFromCGSize(self.image.size), self.image.imageOrientation];
...
@implementation UIImagePickerController(Hide_Status)
- (void)hideStatusBar{
