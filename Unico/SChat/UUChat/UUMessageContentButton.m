...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.backImageView.backgroundColor = [UIColor clearColor];//[UIColor yellowColor];
...
//    CGContextMoveToPoint(contextRef, self.width - .5, (self.height - 12)/2);
//    CGContextAddLineToPoint(contextRef, self.width + 6, self.height/2);
//    CGContextAddLineToPoint(contextRef, self.width - .5, (self.height + 12)/2);
//    
