//
//  SCollocationCommentCollectionViewCell.m
//  Wefafa
//
...
@interface SCollocationCommentCollectionViewCell ()<UIScrollViewDelegate>
...
@implementation SCollocationCommentCollectionViewCell
...
- (void)setContentModel:(CommentListModel *)contentModel{
    ...
    [self.showUserImageView sd_setImageWithURL:[NSURL URLWithString:contentModel.head_img]];
