...
// 2.0颜色
//菜单背景色
#define DO_MENU_BACK_COLOR          DO_RGBA(0, 9, 42, 0.98)
//边上上下按钮底色
#define DO_SIDE_BUTTON_COLOR        DO_RGBA(0, 9, 42, 0.98)

//相册选择文字颜色
#define DO_ALBUM_NAME_TEXT_COLOR    DO_RGB(227,100,16)
//相册选择数字颜色
#define DO_ALBUM_COUNT_TEXT_COLOR   DO_RGB(227,100,16)
//底部当前相册颜色
#define DO_BOTTOM_TEXT_COLOR        DO_RGB(227,100,16)
