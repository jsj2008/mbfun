...
//        self.titles = [NSMutableArray arrayWithObjects:NSLocalizedString(@"下拉更新...",),
//                                                       NSLocalizedString(@"松开后加载...",),
//                                                       NSLocalizedString(@"加载中...",),
//                                                       nil];
        self.titles = [NSMutableArray arrayWithObjects:NSLocalizedString(@"下拉,返回上一页",),
                       NSLocalizedString(@"释放,返回上一页",),
                       NSLocalizedString(@"",),
                       nil];
...
- (UILabel *)titleLabel {
    if(!_titleLabel) {
        ...
        _titleLabel.text = NSLocalizedString(@"下拉更新...",);
