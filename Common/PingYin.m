...
//  FaFa
//
//  Created by fafa  on 13-5-23.
//
//

#import "PingYin.h"

@implementation PingYin

// unicode 中汉字的范围[\u4e00 - \u9fa5]
#define HANZI_START 19968
#define HANZI_COUNT 20902
static char PingYingFirstLetters[HANZI_COUNT] =
...
char getPinyinFirstLetter(unsigned short hanzi)
{
	...
	{
		return PingYingFirstLetters[index];
	}
	else
	{
		return '#';
...
+(NSString*)getPingYin:(NSString*)strHan
{
    NSMutableString *re = [NSMutableString stringWithCapacity:10];
    
    char c;
    for (int i = 0; i < [strHan length]; i++)
    {
        c = getPinyinFirstLetter([strHan characterAtIndex:i]);
        if (c == '#') continue;
        [re appendFormat:@"%c", c];
    }
