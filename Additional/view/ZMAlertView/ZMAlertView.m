...
//        [self.leftBtn setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithRed:227.0/255.0 green:100.0/255.0 blue:83.0/255.0 alpha:1]] forState:UIControlStateNormal];
        self.rightBtn.backgroundColor = COLOR_C1;
        [self.leftBtn setBackgroundImage:[UIImage imageNamed:@"btn_gray@2x"] forState:UIControlStateNormal];
        ...
        [self.rightBtn setTitleColor:COLOR_C2 forState:UIControlStateNormal];
