...
//[UIScreen mainScreen].bounds.size.height-50-64
    self.mBackView =[[UIView alloc]initWithFrame:CGRectMake(0, 300, WIDTH_SCREEN, 50)];
    self.mBackView.hidden = YES;
    ...
    [self.mTalkBtn setTitle:@"OK" forState:UIControlStateNormal];
...
{    
    self.isTop =NO;
        ...
        self.mHiddeView =nil;
        self.mTextView.text =@"请添加文字"; //键盘消失时，恢复TextView内容
    }];
}
...
//    self.mSecondaryBackView.frame =CGRectMake(10, 15, 230, selfHeight-20);
    NSLog(@"文字改变");
}
