...
#define increaseWide 20
#define increaseHeight 50
/*
...
//    wrapperView.alpha=0.5;
    ...
    CGFloat wrapperHeight = MAX((messageTop + messageHeight + CSToastVerticalPadding), (imageHeight + (CSToastVerticalPadding * 2)));
        ...
        wrapperView.frame = CGRectMake(0.0, 0.0, wrapperWidth+increaseWide, wrapperHeight+increaseHeight);
    ...
    if(messageLabel != nil) {
        messageLabel.frame = CGRectMake(messageLeft+increaseWide/2, messageTop+increaseHeight/2, messageWidth, messageHeight);
