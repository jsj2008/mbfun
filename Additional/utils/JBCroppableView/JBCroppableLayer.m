...
- (id)initWithImageView:(UIImageView *)imageView
{
    ...
    if (self) {
        ...
        self.pointColor      = [UIColor colorWithHexString:@"#353535"];
        self.lineColor       = [UIColor colorWithHexString:@"#353535"];
...
-(UIImage *)getCroppedImageForView:(UIImageView *)view withTransparentBorders:(BOOL)transparent{
    ...
    CAShapeLayer *shapeLayer = [CAShapeLayer layer];
    shapeLayer.frame = CGRectMake(0, 0, view.frame.size.width, view.frame.size.height);
    shapeLayer.path = path.CGPath;
    shapeLayer.fillColor = [[UIColor whiteColor] CGColor];
    shapeLayer.backgroundColor = [[UIColor clearColor] CGColor];
...
//    UIView *point2 = [self.points objectAtIndex:1];
//    CGContextRef context = UIGraphicsGetCurrentContext();
//    CGContextSetRGBStrokeColor(context,255, 255, 0, 1.0);//线条颜色
//    CGContextMoveToPoint(context, point1.frame.origin.x +k_POINT_WIDTH/2, point1.frame.origin.y +k_POINT_WIDTH/2);
//     CGContextAddLineToPoint(context, point2.frame.origin.x +k_POINT_WIDTH/2, point2.frame.origin.y +k_POINT_WIDTH/2);
//   
