...
+ (MBProgressHUD *)showHUDAddedTo:(UIView *)view animated:(BOOL)animated {
    ...
    hud.opacity = 0.;
	[view addSubview:hud];
    [hud changeHudIndicatorStyle:UIActivityIndicatorViewStyleGray];
	[hud show:animated];
	return MB_AUTORELEASE(hud);
}

-(void)changeHudIndicatorStyle:(UIActivityIndicatorViewStyle)style
{
    if ([self.indicator isKindOfClass:[UIActivityIndicatorView class]]) {
        [(UIActivityIndicatorView*)self.indicator setActivityIndicatorViewStyle:style];
    }
}
/********************zhu*******************/
//初始化
...
//失败消失
+(MBProgressHUD *)HUDFailure:(NSString *)str{
...
- (void)layoutSubviews {
	...
	CGSize labelSize = [label.text rtSizeWithFont:label.font];
	...
	CGSize detailsLabelSize = [detailsLabel.text rtSizeWithFont:detailsLabel.font 
