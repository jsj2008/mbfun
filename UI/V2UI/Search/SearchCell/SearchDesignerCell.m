...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(55, 13, 45, 15)];
...
//        [self.contentView addSubview:_collocationLabel];
        ...
        [_favoriteBtn setFrame:CGRectMake(self.frame.size.width - 61, 20, 61, 28)];
...
//        [_remarkLabel setTextColor:[UIColor colorWithRed:0.796 green:0.796 blue:0.796 alpha:1.0]];
        ...
        UIView *line = [[UIView alloc] initWithFrame:CGRectMake(0, 67.5, self.frame.size.width, 0.5)];
...
- (CGFloat)calcStrLengthWithLabel:(UILabel *)label title:(NSString *)title count:(NSInteger)count xPoint:(CGFloat)xPoint
{
    ...
    CGSize aSize = [str sizeWithFont:[UIFont systemFontOfSize:12] constrainedToSize:CGSizeMake(100, 20)];
...
//    CGFloat xPoint = [self calcStrLengthWithLabel:_collocationLabel title:@"搭配" count:model.designCount xPoint:self.frame.size.width - 10];
   ...
   CGFloat xPoint = [self calcStrLengthWithLabel:_fansLabel title:@"粉丝" count:model.fansCount xPoint:_nameLabel.frame.origin.x];
    ...
    CGSize aSize = [name sizeWithFont:[UIFont systemFontOfSize:13.0] constrainedToSize:CGSizeMake(300, 20)];
...
//    [_headerImg setImage:[UIImage imageNamed:@"pic_loading@3x.png"]];
    ...
    if (!model.isConcerned) {
        [_favoriteBtn setImage:[UIImage imageNamed:@"add_attend"] forState:UIControlStateNormal];
    } else {
        [_favoriteBtn setImage:[UIImage imageNamed:@"btn_match_selected"] forState:UIControlStateNormal];
    }
