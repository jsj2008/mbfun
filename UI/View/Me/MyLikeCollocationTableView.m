...
@implementation MyLikeCollocationTableView
...
- (void)innerInit
{
    ...
    MyLikeCollocationTableViewCell *cell1=[[[NSBundle mainBundle] loadNibNamed:@"MyLikeCollocationTableViewCell" owner:self options:nil] objectAtIndex:0];
...
{
    NSString *AIdentifier =  @"MyLikeCollocationTableViewCell";
    MyLikeCollocationTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:AIdentifier];
    if (cell == nil) {
