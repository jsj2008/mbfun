...
//参数isLoadThumbnail表示是否加载缩略图
- (void)sd_setImageWithURL:(NSURL *)url isLoadThumbnail:(BOOL)isLoadThumbnail;

//参数isLoadThumbnail表示是否加载缩略图
- (void)sd_setImageWithURL:(NSURL *)url isLoadThumbnail:(BOOL)isLoadThumbnail placeholderImage:(UIImage *)placeholder;
