...
static int HEIGHT = 22+22; //height of the alert view
...
static int STATUS_BAR_HEIGHT = 20;//20
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(X_BUFFER, STATUS_BAR_HEIGHT, frame.size.width-2*X_BUFFER, 22)];//30
        ...
        messageLabel = [[UILabel alloc]initWithFrame:CGRectMake(X_BUFFER, STATUS_BAR_HEIGHT +Y_BUFFER*2.3, frame.size.width-2*X_BUFFER, 22)];//40
